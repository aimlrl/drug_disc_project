...
def run_training():
    ...
    history = drug_discovery_model.fit(training_data_generator(1000,25),epochs=25,steps_per_epoch=1000,
...
if __name__=="__main__":
    ...
    mlflow.logs(loaded_model,model_history,loaded_model_name)
